			...
			<main class="container" style="max-width: 700px; margin: 2rem auto; padding: 0 1rem;">
				...
				<div class="card" style="padding: 2rem;">
					...
					<table style="width: 100%; border-collapse: collapse;">
						<tr>
							<th style="text-align:left; padding: 0.6rem 1rem 0.6rem 0; width: 40%; color: #555;">
								Descrição</th>
						...
						<tr>
							<th style="text-align:left; padding: 0.6rem 1rem 0.6rem 0; color: #555;">Local encontrado
							</th>
							<td style="padding: 0.6rem 0;">
						...
						<tr style="background: #f9f9f9;">
							<th style="text-align:left; padding: 0.6rem 1rem 0.6rem 0; color: #555;">Data encontrado
							</th>
						...
						<tr>
							...
							<td style="padding: 0.6rem 0;">
								<span class="badge <c:choose><c:when test=" ${item.status=='ACHADO' }">badge-achado
									</c:when>
									<c:otherwise>badge-devolvido</c:otherwise>
									</c:choose>">
									${item.status}
								</span>
							</td>
						...
						<tr style="background: #f9f9f9;">
							<th style="text-align:left; padding: 0.6rem 1rem 0.6rem 0; color: #555;">Data de cadastro
							</th>
						...
						<c:if test="${not empty item.observacoes}">
							<tr>
								<th
									style="text-align:left; padding: 0.6rem 1rem 0.6rem 0; color: #555; vertical-align: top;">
									Observações</th>
								<td style="padding: 0.6rem 0;">
									<c:out value="${item.observacoes}" />
								</td>
							</tr>
						</c:if>
					</table>
					...
					<c:if test="${not empty item.fotoPath}">
						<div style="margin-top: 1.5rem;">
							...
							<img src="${pageContext.request.contextPath}/uploads/${item.fotoPath}" alt="Foto do item"
