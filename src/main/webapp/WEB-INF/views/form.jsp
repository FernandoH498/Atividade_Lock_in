							...
							<div class="form-grid">
								...
								<div class="form-group full-width">
									...
									<input type="text" id="descricao" name="descricao" class="form-control"
										placeholder="Ex: Mochila escolar preta com zíper amarelo" maxlength="255"
								...
								<div class="form-group">
									...
									<select id="categoria" name="categoria" class="form-control">
										...
										<option value="ELETRÔNICOS" <c:if test="${cat == 'ELETRÔNICOS'}">selected</c:if>
											>Eletrônicos</option>
										<option value="DOCUMENTOS" <c:if test="${cat == 'DOCUMENTOS'}">selected</c:if>
											>Documentos</option>
										<option value="ROUPAS" <c:if test="${cat == 'ROUPAS'}">selected</c:if>>Roupas
										</option>
										<option value="ACESSÓRIOS" <c:if test="${cat == 'ACESSÓRIOS'}">selected</c:if>
											>Acessórios</option>
										<option value="OUTROS" <c:if test="${cat == 'OUTROS'}">selected</c:if>>Outros
										</option>
									</select>
								</div>
								...
								<div class="form-group">
									...
									<input type="text" id="localEncontrado" name="localEncontrado" class="form-control"
										placeholder="Ex: Refeitório Central" value="<c:out value="
								...
								<div class="form-group">
									...
									<input type="date" id="dataEncontrado" name="dataEncontrado" class="form-control"
